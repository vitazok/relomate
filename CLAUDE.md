...
- **Phase 3B (approvals & review, branch — pending PR) decisions — do NOT redebate** (full write-up: context-history.md; spec/plan: `docs/superpowers/{specs,plans}/2026-06-04-phase-3b-approvals-review*.md`):
