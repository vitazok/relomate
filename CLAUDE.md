...
- **4C-F** — continue the firm foundation pivot: internal notes, firm knowledge scaffolding, Canada/Toronto config/personas (4C-F-6). Portal currently shows a read-only client task list — upload/confirm/message widgets and manual-task UI are deferred follow-ups.
