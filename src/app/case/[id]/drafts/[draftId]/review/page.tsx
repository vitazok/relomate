...
export default async function DraftReviewPage({
  ...
  if (draft.type !== 'cover_letter' || draft.content?.type !== 'cover_letter') notFound();
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-8">
      ...
      <h1 className="mt-2 mb-4 text-lg font-medium text-zinc-900">Review cover letter</h1>
      <DraftReviewForm caseId={caseId} draftId={draftId} initial={draft.content.data} />
    </div>
  );
}
